    ...
    public partial class KhoiTao : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                c => new
                    {
                        IDNha = c.Int(nullable: false, identity: true),
                        Tenduong = c.String(maxLength: 500),
                        DienTich = c.String(),
                        TenChuNha = c.String(maxLength: 50),
                        SDT = c.String(),
                        CTNha = c.String(maxLength: 500),
